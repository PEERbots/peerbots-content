    ...
    <footer className="grid grid-cols-1 text-center md:grid-cols-3 md:h-16 align-middle py-4 justify-evenly bg-white shadow-md my-4 mx-2 rounded">
      <div className="my-2 mx-4 text-xs">
        <a href="https://peerbots.org" target="_blank" rel="noreferrer">
          © 2025 Peerbots, 501(c)3 85-1894594
        </a>
      </div>
      <div className="my-2 space-x-2">
        <span className="inline-block">
          <a
            href="https://www.facebook.com/peerbots"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <span className="inline-block">
          <a
            href="https://www.instagram.com/peerbots/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <span className="inline-block">
          <a
            href="https://www.twitter.com/peerbotsinc"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <span className="inline-block">
          <a
            href="https://www.github.com/peerbots"
            target="_blank"
            rel="noreferrer"
          >
            <svg
      ...
      <div className="my-2 text-xs">
        <a href="mailto:hello@peerbots.org" target="_blank" rel="noreferrer">
          hello@peerbots.org
        </a>
      </div>
    </footer>
